...
pub use clawhdf5_format::file_writer::AttrValue;

/// Simplified datatype enum for the high-level API.
///
/// Maps from the detailed `clawhdf5_format::datatype::Datatype` to a
...
pub(crate) fn classify_datatype(dt: &clawhdf5_format::datatype::Datatype) -> DType {
