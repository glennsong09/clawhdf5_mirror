...
//
// Canonical location per the P1.1 platform-evaluation artifact requirement
// (S2-D2 spec, step 6): this generator is committed here, not the HDF5 file
// it produces. Run via `cargo run --example generate_10gb --release [SIZE_GB] [OUTPUT_PATH]`
// (see crates/clawhdf5/examples/generate_10gb.rs, which includes this file).
//
// Examples:
